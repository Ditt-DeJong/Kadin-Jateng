...
export default function Navbar() {
  ...
  return (
    <nav className="sticky top-0 py-2 z-50 bg-white/80 backdrop-blur-2xl border-b border-primary/[0.06]">
      <div className="max-w-6xl mx-auto flex h-[72px] items-center justify-between px-6 lg:px-8">
        ...
        <div className="hidden md:flex items-center gap-1">
          ...
          <Link
            href="/daftar"
            className="btn-gold rounded-full px-4 py-2 text-[0.8125rem]"
          >
            Daftar SBU
          </Link>
        </div>
