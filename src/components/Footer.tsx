      ...
      <div className="relative max-w-6xl mx-auto px-6 lg:px-8 pt-16 pb-10">
        <div className="grid md:grid-cols-12 gap-12 mb-14">
          ...
          <div className="md:col-span-5">
            ...
            <p className="text-white/45 text-[0.8125rem] leading-relaxed max-w-xs">
            ...
            <div className="flex flex-col gap-3">
              {[
                ...
                <Link
                  key={link.href}
                  href={link.href}
                  className="text-[0.8125rem] text-white/45 hover:text-white transition-colors duration-300"
                >
                  {link.label}
                </Link>
              ))}
          ...
          <div className="md:col-span-4">
            ...
            <div className="flex flex-col gap-3.5">
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-[0.8125rem] text-white/45">(024) 3561463</span>
              </div>
              <div className="flex items-center gap-3">
                <Mail className="h-4 w-4 text-gold/70 shrink-0" />
                <span className="text-[0.8125rem] text-white/45">info@kadinjateng.or.id</span>
              </div>
              <div className="flex items-center gap-3">
                <Clock className="h-4 w-4 text-gold/70 shrink-0" />
                <span className="text-[0.8125rem] text-white/45">Sen — Jum: 08.00 — 16.00 WIB</span>
              </div>
            </div>
          </div>
        </div>
